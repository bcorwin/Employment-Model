...
quietly infix                 ///
  ...
  int     hispand    91-93    ///
  byte    racesing   94-94    ///
  byte    racesingd  95-96    ///
  byte    racamind   97-97    ///
  byte    racasian   98-98    ///
  byte    racblk     99-99    ///
  byte    racpacis   100-100  ///
  byte    racwht     101-101  ///
  byte    racother   102-102  ///
  byte    racnum     103-103  ///
  byte    educ       104-105  ///
  int     educd      106-108  ///
  byte    empstat    109-109  ///
  byte    empstatd   110-111  ///
  byte    labforce   112-112  ///
  int     occ        113-116  ///
  int     ind        117-120  ///
  byte    wkswork2   121-121  ///
  byte    uhrswork   122-123  ///
  byte    absent     124-124  ///
  byte    looking    125-125  ///
  byte    availble   126-126  ///
  byte    wrkrecal   127-127  ///
  byte    workedyr   128-128  ///
  long    inctot     129-135  ///
  long    ftotinc    136-142  ///
  long    incwage    143-148  ///
  using `"usa_00002.dat"'
